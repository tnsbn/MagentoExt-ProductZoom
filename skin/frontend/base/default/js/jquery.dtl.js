...
(function($){
	$.fn.dtl = function(options){
		...
		$.each(this, function(){
			var $container = $(this);
			$container.on('dtl_play', function() {
				startAutoplay();
			});
			$container.on('dtl_stop', function() {
				stopAutoplay();
			});
			$container.on('dtl_prev', function() {
				prev();
			});
			$container.on('dtl_next', function() {
				next();
			});
...
// NEW ELEMENTS & CACHE
				$container.addClass('etalage').show();//ko co thi list etalage_small_thumbs se tuot xuong
				var $thumbs = $container.children('li').addClass('etalage_thumb hidden');
				...
				//luong
				// Move products-thumbs into list
				$li = $('<li></li>').addClass('dtl_products_thumb');
				$li.prepend($('div.products-thumbs'));
				...
				if(images > 1 || !o.smallthumb_hide_single){
					if(smallthumbs_align==='vert'){
						...
						if(o.smallthumbs_position==='left'){
							...
							$('.dtl_products_thumb').css({ left:smallthumb_outerwidth+smallthumb_margin+5 });
						}else{
							css.marginLeft = thumb_outerwidth + smallthumb_margin + 5;
						}
						$smallthumbs.css(css);
						...
						// Navi arrow buttons
						$('.etalage_small_thumbs').append($('.dtl_up'));
						$('.etalage_small_thumbs').append($('.dtl_down'));
						$('.dtl_up').removeClass('hidden');
						$('.dtl_down').removeClass('hidden');
						dtlLeft = (smallthumb_outerwidth - $('.dtl_up img').width()) / 2;
						$('.dtl_up').width(smallthumb_width);
						$('.dtl_up').css({ left: 0, top: 0 });
						$('.dtl_up img').css({ left: dtlLeft, top: 0 });
						$('.dtl_down').width(smallthumb_width);
						$('.dtl_down').css({ left: 0, bottom: 0 });
						$('.dtl_down img').css({ left: dtlLeft, bottom: 0 });
					}else{
						css = { width:thumb_outerwidth };
						if(o.smallthumbs_position==='top'){
							$thumbs.css({ top:smallthumb_outerheight+smallthumb_margin });
							$('.dtl_products_thumb').css({ top:smallthumb_outerheight+smallthumb_margin+5 });
						}else{
							css.top = thumb_outerheight + smallthumb_margin+5;
						}
						$smallthumbs.css(css);
						...
						// Navi arrow buttons
						$('.etalage_small_thumbs').append($('.dtl_left'));
						$('.etalage_small_thumbs').append($('.dtl_right'));
						$('.dtl_left').removeClass('hidden');
						$('.dtl_right').removeClass('hidden');
						dtlTop = (smallthumb_outerheight - $('.dtl_left img').height()) / 2;
						$('.dtl_left').height(smallthumb_height);
						$('.dtl_left').css({ left: 0, top: 0 });
						$('.dtl_left img').css({ left: 0, top: dtlTop });
						$('.dtl_right').height(smallthumb_height);
						$('.dtl_right').css({ right: 0, top: 0 });
						$('.dtl_right img').css({ right: 0, top: dtlTop });
					}
					$('.dtl_products_thumb').find('#image').css({ width:o.thumb_image_width, height:o.thumb_image_height });
...
// CALLBACK FUNCTIONS
				...
				var change_callback = function(image_number){
					...
					jQuery('.cloud-zoom-big').remove();
					jQuery('a#cloudZoom').attr('href', $current_source.attr('src'));
					jQuery('a#cloudZoom').attr('gallery', $current_source.attr('src'));
					jQuery('a#cloudZoom #image').attr('src', $current_thumb.data('src'));
					jQuery('a#cloudZoom').CloudZoom();
